...
# colors.lighter  <- c("#999999", "#0BD919", "#4182F2", "#FFB000", "#FC3728")
...
# bs.col.lighter <- c("#F48371", "#87BCF4", "#C6EA98", "#F9D991")

################ GGPLOT 2 ################

theme_SE  <- function (base_size = 14, base_family = "", ...)
               {
                  theme_classic (base_size = base_size, base_family = base_family)  %+replace%
                    theme (
                      axis.line = element_line(size = .75, color = "black"),
                      axis.line.x = element_line(size = .75, color = "black"),
                      axis.line.y = element_line(size = .75, color = "black"),
                      panel.grid.major.x = element_line(size = .5, 0, color = NA), 
                      panel.grid.minor.y = element_line(size = 0, color = NA), 
                      panel.grid.major.y = element_line(size = .5, 0, color = NA), 
                      panel.grid.major = element_line(size = .5, 0, color = NA), 
                      panel.grid.minor.x = element_line(size = 0, color = NA),
                      panel.background = element_rect(fill = NA, color = NA),
                      legend.background = element_rect(fill=NA, color=NA),
                      strip.text = element_text(size = 12, colour = "black", face = "bold"), # facet wrap strip
...
# theme_wout <-   theme_classic(base_size = 23) +
#                 theme(),
